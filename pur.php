...
<body style="background:linear-gradient(rgba(47, 23, 15, 0.65), rgba(47, 23, 15, 0.65)), url('assets/img/bg.jpg');">
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span class="text-primary site-heading-upper mb-3"><strong>ADMIN SPACE: Purchases</strong><br></span><span class="site-heading-lower">				<div class="caption v-middle text-center">
        ...
        <div class="container">
            <div class="card" id="TableSorterCard">
                            ...
                            <table class="table table tablesorter" id="ipi-table">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th class="">CIN User</th>
                                        <th class="">ID_prod</th>
                                        <th class=" ">Date_commande</th>
               ...
               foreach($selectRes as $val) {
                ...
                <td>'.$val['CIN_user'].'</td>
                <td>'.$val['ID_prod'].'</td>
                <td>'.$val['Date_commande'].'</td>
                
                
               
                
                <td><a  class="badge badge-primary badge-sm"  id="btn">Modifier</a></td>
                <td><a href="includes/sup2.php?id='.$val['ID_prod'].'" class="badge badge-danger badge-sm">Supprimer</a></td>
                </tr>';
            }
            ?>         
